...
**3-month plan (Google L4 dual track):** [3_month_plan.md](./3_month_plan.md) — DSA (BS → trees → graphs → DP) + FINAL 120 merged embedded, week by week

| Folder | Status |
|--------|--------|
| [binary search](./binary%20search/README.md) | BS-1 to BS-27 + [cheatsheet](./binary%20search/CHEATSHEET.md) |
